...
(*  Structures for new IR3 (for code generation) of JLite language  *)
(* ================================================================ *)

open Ir3_structs
open Jlite_structs (* Not very good practicing *)
open Arm_structs
...
let md_decl3_to_md_decl3_new
	...
	match input with
	| { Ir3_structs.id3=i; Ir3_structs.rettype3=t; Ir3_structs.params3=vlst; Ir3_structs.localvars3=lvlst; Ir3_structs.ir3stmts=ir3stmtlst }->
		{
